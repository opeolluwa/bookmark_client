...
#[leptos::component]
pub fn MobileAppLayout(children: Children) -> impl leptos::IntoView {
    ...
    view! {
        <div class="relative h-[95vh] overflow-y-hidden w-full bg-white dark:bg-base-100">
            ...
            <nav class="fixed pt-4 mb-0 fixed bottom-0 z-50  bg-white border-t border-gray-200 text-gray-500/70 shadow-gray-400 w-full left-0 right-0 py-3 dark:bg-gray-900/50 border-t-2 border-gray-500">
                <BottomNavigation />
            </nav>
        </div>
    }
