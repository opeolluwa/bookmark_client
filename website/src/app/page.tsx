      ...
      <section className="bg-white my-40 py-8 lg:px-24 flex  justify-center items-center">
        <View className="bg-app-600 grid grid-cols-12 justify-center items-center shadow-sm shadow-gray-300 text-white rounded-3xl px-8 py-10 leading-1">
          <div className="col-span-6">
            <img src="/assets/secure.png" className="grayscale w-full" />
          </div>
          <div className="col-span-6">
            <Heading className="text-5xl tracking-tight leading-2 w-2/3">
              Secured by blockchain and AI
            </Heading>
            <Text className=" text-white text-[24px] leading-loose mt-4">
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Ex velit
              vero exercitationem facilis consequuntur quisquam numquam
              excepturi deserunt placeat distinctio repellendus recusandae
              similique, quis at cum sequi nulla, saepe a!
            </Text>
          </div>
        </View>
      </section>
