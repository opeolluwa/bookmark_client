...
use crate::proto::vault::{
    vault_manager_server::VaultManager, DeleteVaultRequest, DeleteVaultResponse, GetVaultRequest,
    GetVaultResponse, ListVaultsRequest, ListVaultsResponse, NewVaultRequest, NewVaultResponse,
